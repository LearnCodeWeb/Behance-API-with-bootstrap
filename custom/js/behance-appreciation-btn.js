(function( $ ) {
    $.fn.behanceButton = function( id ) {
        ...
        var timestamp = new Date().getTime(),
            upvote_url = 'http://www.behance.net/c/a?e=project&s=1&use_jquery=1&count=1&stamp=' + timestamp + '&id=' + id,
            project_iframe = "<iframe id='project_page_" + id + "' src='http://behance.net/gallery/Zaid-Bin-Khalid/" + id + "' style='display: none'></iframe>",
